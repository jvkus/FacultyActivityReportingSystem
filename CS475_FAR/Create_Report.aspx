    ...
    <div>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtTeaching" runat="server" Height="117px" Width="413px" TextMode="MultiLine" CssClass="auto-style23" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtReflect" runat="server" Height="117px" Width="413px" TextMode="MultiLine" CssClass="auto-style23" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtService" runat="server" Height="117px" Width="413px" TextMode="MultiLine" CssClass="auto-style23" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtServiceReflect" runat="server" Height="117px" Width="413px" TextMode="MultiLine" CssClass="auto-style23" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtScholarly" runat="server" Height="117px" Width="413px" TextMode="MultiLine" CssClass="auto-style23" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtScholarlyReflect" runat="server" Height="117px" Width="413px" TextMode="MultiLine" CssClass="auto-style23" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtNarrative" runat="server" Height="117px" Width="413px" TextMode="MultiLine" CssClass="auto-style23" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
